...
public class FileController {
    ...
    public UploadFileResponse uploadEventImage(@RequestParam("file") MultipartFile file, @RequestParam(name="eid", defaultValue="1") Long eventId)
            {
        ...
        //     System.out.println(oldpicfilename);
        //     Path oldFilepath = Paths.get(this.fileStorageProperties.getUploadDir() + "/eventPics/" + eventId + oldpicfilename)
        //             .toAbsolutePath().normalize();
        //     System.out.println(oldFilepath);
        //     try {
        //         Files.deleteIfExists(oldFilepath);
