...
public class DataInitRunner implements ApplicationRunner {
    ...
    private void createEvent() {
        ...
        event.setDescriptions("The 14th Annual Academic Success Lecture featuring Dr. Kevin Gumienny is . This year's presentation will be held physically, and will focus on the topics of accessibility and universal design.");
