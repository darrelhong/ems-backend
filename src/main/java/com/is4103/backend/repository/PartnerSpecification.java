...
public class PartnerSpecification implements Specification<BusinessPartner> {

    private static final long serialVersionUID = 1L;

    private PartnerSearchCriteria criteria;

    public PartnerSpecification(PartnerSearchCriteria criteria) {
        super();
